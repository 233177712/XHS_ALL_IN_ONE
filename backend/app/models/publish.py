...
class PublishJob(Base):
    ...
    platform_account_id: Mapped[int | None] = mapped_column(ForeignKey("platform_accounts.id"), nullable=True, index=True)
    source_draft_id: Mapped[int | None] = mapped_column(ForeignKey("ai_drafts.id"), nullable=True)
