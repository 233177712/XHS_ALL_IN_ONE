...
export function XhsVideoStudioPage() {
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      ...
      <Card style={{ background: "#1a1a1a", borderRadius: 8, border: "1px solid #303030" }} styles={{ body: { padding: 48 } }}>
        <Empty
          ...
          description={
            <div>
              ...
              <Text type="secondary">视频剪辑、封面提取、视频转码、AI 视频润色等功能正在开发中，敬请期待。</Text>
            </div>
          }
        />
      </Card>
