...
import { Avatar, Badge, Button, Col, Dropdown, Layout, List, Menu, Row, Space, Typography } from "antd";
            ...
            renderItem={(n) => (
              <List.Item
                ...
                style={{
                  ...
                  background: n.read ? "transparent" : "rgba(22,104,220,0.06)",
      ...
      >
        <div style={{ display: "flex", flexDirection: "column", height: "100%" }}>
          ...
          <div style={{ flexShrink: 0, borderTop: "1px solid #303030" }}>
            ...
            >
              <Avatar size={22} icon={<UserOutlined />} style={{ background: "#1668dc", flexShrink: 0, fontSize: 11 }}>
                {(auth.user?.username ?? "U")[0].toUpperCase()}
              </Avatar>
              {!collapsed && (
                <>
                  <Text type="secondary" ellipsis style={{ fontSize: 12, flex: 1, lineHeight: "22px" }}>
      ...
      <Layout style={{ marginLeft: siderWidth, transition: "margin-left 0.2s" }}>
        ...
        >
          <Space size={12} align="center">
            ...
            <Avatar size={28} style={{ background: "#1668dc", fontSize: 12, cursor: "default" }}>
              {(auth.user?.username ?? "U")[0].toUpperCase()}
            </Avatar>
          </Space>
        </Header>
